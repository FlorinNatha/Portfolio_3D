...
const DemoComputer = (props) => {
  ...
  const textureUrl = props.texture ? props.texture : '/textures/project/project1.mp4';
  const isVideo = textureUrl.endsWith('.mp4') || textureUrl.endsWith('.webm');
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          ...
          {isVideo ? <VideoScreen url={textureUrl} /> : <ImageScreen url={textureUrl} />}
        </mesh>
